...
import com.example.cursomc.dominio.*;
import com.example.cursomc.dominio.enums.EstadoPagamento;
import com.example.cursomc.dominio.enums.TipoCliente;
...
public class CursomcApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //Referencia Categoria e Produtos
        ...
        //Referencia Estado e Cidades
        Estado est1 = new Estado(null,"Minas Gerais");
        Estado est2 = new Estado(null,"São Paoulo ");

        Cidade c1 = new Cidade(null, "Uberândia",est1);
        ...
        //Referencias do Clinte e Endereço
